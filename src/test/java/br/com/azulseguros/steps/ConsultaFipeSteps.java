...
public class ConsultaFipeSteps {
    ...
    public void o_usuario_esta_logado_com_um_dos_perfis_sinistro_regulacao() {
        ...
        login.informarUsername("romulosilva.ilab@azulseguros.com.br.qa");
        login.informarSenha(TestConstants.PASSWORD);
        ScreenshotUtils.captureScreenshot(StepData.driver, "o usuário está logado com um dos perfis Sinistro Regulacao");
        login.acionarBotaoLogin();
    }
    ...
    public void o_usuario_esta_logado_com_um_dos_perfis_integracao_sf() {
        ...
        login.informarUsername("romulosilva.ilab@azulseguros.com.br.qa");
        login.informarSenha(TestConstants.PASSWORD);
        ScreenshotUtils.captureScreenshot(StepData.driver, "o usuário está logado com um dos perfis Integracao SF");
        login.acionarBotaoLogin();
    }
